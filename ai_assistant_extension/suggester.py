...
def suggest_next_cell(selected_cell_source, previous_context, next_context, previous_summaries, future_summaries, generated_sug_titles):
    # print("============= AI suggesting =============")
    ...
    if USE_OLLAMA:
        message = build_suggestions_prompt(selected_cell_source, previous_context, next_context, previous_summaries, future_summaries, generated_sug_titles)
